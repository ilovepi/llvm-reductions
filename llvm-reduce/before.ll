; *** IR Dump After EarlyCSEPass on _Z3fn3b ***
; ModuleID = 'pb_decode-18f258.cpp'
...
do.body.i:                                        ; preds = %if.end22.i, %entry
  %call.i = call noundef zeroext i1 @_Z1gv() #5, !dbg !50
...
if.then5.i:                                       ; preds = %if.then3.i
  %1 = load ptr, ptr inttoptr (i32 4 to ptr), align 4, !dbg !61
  %tobool6.not.i = icmp eq ptr %1, null, !dbg !61
  %..str.i = select i1 %tobool6.not.i, ptr @.str, ptr %1, !dbg !61
  store ptr %..str.i, ptr inttoptr (i32 4 to ptr), align 4, !dbg !61
  br label %_ZL1hPjb.exit, !dbg !61

if.end9.i:                                        ; preds = %if.then3.i
  %2 = load i8, ptr @a, align 1, !dbg !62
  %tobool10.not.i = icmp eq i8 %2, 0, !dbg !62
  br i1 %tobool10.not.i, label %do.end.i, label %if.then11.i, !dbg !64

if.then11.i:                                      ; preds = %if.end9.i
  %3 = load ptr, ptr inttoptr (i32 4 to ptr), align 4, !dbg !65
  %tobool13.not.i = icmp eq ptr %3, null, !dbg !65
  %..str25.i = select i1 %tobool13.not.i, ptr @.str, ptr %3, !dbg !65
  store ptr %..str25.i, ptr inttoptr (i32 4 to ptr), align 4, !dbg !65
  br label %_ZL1hPjb.exit, !dbg !65
...
_ZL1hPjb.exit:                                    ; preds = %if.then5.i, %if.then11.i, %do.end.i
